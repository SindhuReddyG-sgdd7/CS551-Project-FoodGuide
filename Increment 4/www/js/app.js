...
smartEatingApp.controller("HomeController", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
    
});
    
smartEatingApp.controller("RegistrationController", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
...
smartEatingApp.controller("RecipeSearchController", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
...
smartEatingApp.controller("RestaurantSearchCntrlr", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
...
smartEatingApp.controller("RestaurantDetailsController", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
...
smartEatingApp.controller("AllergicController", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
    $scope.openNav = function() {
        document.getElementById("mySidenav").style.width = "250px";
    }
...
smartEatingApp.controller("TranslateController", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
    $scope.openNav = function() {
        document.getElementById("mySidenav").style.width = "250px";
    }
...
smartEatingApp.controller("AboutUsController", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
    $scope.openNav = function() {
        document.getElementById("mySidenav").style.width = "250px";
    }
...
smartEatingApp.controller("UpdatePasswordController", function($scope, $http, $state, $httpParamSerializerJQLike, $q) {
    $scope.openNav = function() {
        document.getElementById("mySidenav").style.width = "250px";
    }
